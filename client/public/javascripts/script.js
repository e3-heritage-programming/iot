...
/*    	    	$.get("/weather?longitude="+longitude+"&latitude="+latitude, function( data ) {
    	    	...
    	    	$.get(  "/RemoteLocations/"+$(this).val(), function( data ) {
		    	    ...
		    	    $.each(obj.location,function(i,v){ 
		    	    	...
		    	    	if(userTemperature > commodityUpperThresholdTemp || userTemperature < commodityLowerThresholdTemp){
			    	    	$("#location-table-body").append("<tr><td>"+v.locationName+"</td><td>"+v.countryName+"</td><td>"+"No"+"</td></tr>");
		    	    	}
		    	    	
		    	    	else{
			    	    	$("#location-table-body").append("<tr><td>"+v.locationName+"</td><td>"+v.countryName+"</td><td>"+"Yes"+"</td></tr>");
		    	    	} 	
		    	    });
    	    	});    	   
      });
